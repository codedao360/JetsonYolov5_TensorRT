...
class YoloTRT():
    def __init__(self, library, engine, conf, yolo_ver):
        ...
        self.categories = ["camdinguocchieu","stop", "nostopnopark", "camdo", "camoto", "camotorephai", "camotoretrai", "phairephai", "phairetrai", "phaidithang", "camretrai",
            "camrephai", "nguoidibo", "treem", "giaovoiduonguutien", "nguoidibo_vang"]
